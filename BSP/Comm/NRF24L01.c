...
void NRF24L01_W_CE(uint8_t BitValue)
{
    ...
    GPIO_WriteBit(NRF24L01_CE_GPIO_PORT, NRF24L01_CE_GPIO_PIN, (BitAction)BitValue);
}
...
void NRF24L01_W_CSN(uint8_t BitValue)
{
    ...
    GPIO_WriteBit(NRF24L01_CSN_GPIO_PORT, NRF24L01_CSN_GPIO_PIN, (BitAction)BitValue);
}
...
void NRF24L01_W_SCK(uint8_t BitValue)
{
    ...
    GPIO_WriteBit(NRF24L01_SCK_GPIO_PORT, NRF24L01_SCK_GPIO_PIN, (BitAction)BitValue);
}
...
void NRF24L01_W_MOSI(uint8_t BitValue)
{
    ...
    GPIO_WriteBit(NRF24L01_MOSI_GPIO_PORT, NRF24L01_MOSI_GPIO_PIN, (BitAction)BitValue);
}
...
{
    /*取MISO引脚的高低电平并返回*/
    return GPIO_ReadInputDataBit(NRF24L01_MISO_GPIO_PORT, NRF24L01_MISO_GPIO_PIN);
}
...
{
    /* 开启GPIO时钟 */
    RCC_APB2PeriphClockCmd(NRF24L01_CE_GPIO_CLK | NRF24L01_CSN_GPIO_CLK | 
                          NRF24L01_SCK_GPIO_CLK | NRF24L01_MOSI_GPIO_CLK | NRF24L01_MISO_GPIO_CLK, ENABLE);
...
uint8_t NRF24L01_Send(uint8_t *DataArray, uint8_t DataSize)
{
    ...
    NRF24L01_WriteTxPayload(DataArray, DataSize);
...
uint8_t NRF24L01_Receive(uint8_t *DataArray, uint8_t DataSize)
{
    ...
    else if ((Status & 0x40) == 0x40)    //状态寄存器位6（RX_DR）为1
    {
        ...
        NRF24L01_ReadRxPayload(DataArray, DataSize);
