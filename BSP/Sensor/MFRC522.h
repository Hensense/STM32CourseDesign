...
#include "string.h"
// MFRC522射频模块 GPIO宏定义
#define MFRC522_START_STATE     1   /* 0：失能文件 1：使能文件 */
#if MFRC522_START_STATE
/*********************************** RC522 引脚定义 *********************************************/
#define               MFRC522_GPIO_SDA_PORT                         GPIOA
#define               MFRC522_GPIO_SDA_PIN                          GPIO_Pin_5

#define               MFRC522_GPIO_SCK_PORT                         GPIOA
#define               MFRC522_GPIO_SCK_PIN                          GPIO_Pin_4

#define               MFRC522_GPIO_MOSI_PORT                        GPIOA
#define               MFRC522_GPIO_MOSI_PIN                         GPIO_Pin_3

#define               MFRC522_GPIO_MISO_PORT                        GPIOA
#define               MFRC522_GPIO_MISO_PIN                         GPIO_Pin_2

#define               MFRC522_GPIO_RST_PORT                         GPIOA      
