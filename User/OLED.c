...
{ 
	OLED_Clear();
   OLED_DrawBMP(0,0,127,0,BMP0[i]);
   OLED_DrawBMP(0,0,127,1,BMP0[i]);
   OLED_DrawBMP(0,0,127,2,BMP0[i]);
   OLED_DrawBMP(0,0,127,3,BMP0[i]);
   OLED_DrawBMP(0,0,127,4,BMP0[i]);
   OLED_DrawBMP(0,0,127,5,BMP0[i]);
   OLED_DrawBMP(0,0,127,6,BMP0[i]);
   OLED_DrawBMP(0,0,127,7,BMP0[i]);
}
